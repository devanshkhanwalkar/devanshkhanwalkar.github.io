...
function init(u){upperBound=1;if($("#pow").val()){if($("#pow").val()<=2){window.alert("Enter n greater than 2");return false}else if(isNaN($("#pow").val())){window.alert("This is not a Number");return false}else{u=$("#pow").val();power=u}$("#pow").blur()}else power=u;for(var b=u;b>=1;b--)upperBound=upperBound*2;changeGame();$("#title").text(upperBound);$("#myTable").hide();$("#score").val(score);$("#moves").val(moves);setTimeout("gameloading()",100)}
